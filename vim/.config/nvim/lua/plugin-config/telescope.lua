...
vim.keymap.set("n", "<Leader>tq", '<cmd>lua require("telescope.builtin").quickfix()<CR>')

vim.keymap.set("n", "<Leader>tr", '<cmd>lua require("telescope.builtin").registers()<CR>')
...
vim.keymap.set("n", "<Leader>tc", '<cmd>lua require("telescope.builtin").commands()<CR>')

vim.keymap.set("n", "<Leader>tg", '<cmd>lua require("telescope.builtin").git_branches()<CR>')
